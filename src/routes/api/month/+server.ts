...
import { assertFileExists, createRange, getFilename, parseFile, parseWeeksFromDays } from '$lib/server';
...
export async function GET({ url }) {
  ...
  const asleepDurationRange = createRange(days, (day: Day) => day.asleepDuration, durationComparator);
