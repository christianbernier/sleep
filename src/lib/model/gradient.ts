...
export function getGradientForMode(mode: ComparisonMode) {
  switch (mode) {
    case ComparisonMode.IN_BED_TIME: return inBedTimeGradient;
    case ComparisonMode.WAKE_UP_TIME: return wakeUpTimeGradient;
    case ComparisonMode.ASLEEP_DURATION: return asleepDurationGradient;
  }
}
